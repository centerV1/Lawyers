...
export default function OnFooter() {
  ...
  return (
    <section className="relative w-full h-160 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center text-white space-y-6">
        <h3 className="text-[#FF9A00] font-bold tracking-widest text-sm md:text-base uppercase mb-10">
        ...
        <p className="text-lg md:text-xl text-gray-200 mb-15">
          {t("contractus")}
        </p>

        <Button className="w-full max-w-md bg-[#FF9A00] hover:bg-amber-600 text-white h-12 text-lg rounded-md font-medium transition-colors duration-200">
          {t("protect")}
        </Button>
